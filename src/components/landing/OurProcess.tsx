        ...
        <div className="flex flex-col justify-center items-start text-left px-6 py-40">
            ...
            <div className='my-12 leading-loose sm:leading-[3rem] space-y-8 font-secHeading'>
                <SecondaryText size='large' className='font-secHeading'>
                    ...
                    Our commitment to quality and authenticity is unwavering. We believe that every piece of jewelry should tell a story, and our vintage Chanel jewelry does just that. From the streets of Paris to your jewelry box, our process ensures that you receive a piece of history, beautifully preserved and transformed.
                </SecondaryText>
            </div>
        </div>
    );
