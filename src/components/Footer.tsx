  ...
  return (
    <footer className="mt-20 border-t border-gray-100">
      <div className="px-6 py-14 sm:py-16 lg:px-8">
        ...
        {/* 3-column grid */}
        <div className="grid grid-cols-1 gap-12 sm:grid-cols-3 lg:grid-cols-[2fr_1fr_1fr]">

          {/* Brand column */}
          <div className="flex flex-col gap-5">
            <Link href="/">
              <span className="font-accent text-3xl text-gray-900">Amber&apos;s Jewelry Boutique</span>
            </Link>
          ...
          {/* Shop column */}
          <div>
            <p className="mb-5 font-body text-xs font-semibold uppercase tracking-widest text-gray-400">Shop</p>
          ...
          {/* Info column */}
          <div>
            <p className="mb-5 font-body text-xs font-semibold uppercase tracking-widest text-gray-400">Info</p>
            <ul className="flex flex-col gap-3">
              {[
        ...
        {/* Bottom bar: copyright left, Lulu logo right */}
        <div className="mt-14 flex flex-col items-center justify-between gap-4 border-t border-gray-100 pt-8 sm:flex-row">
          ...
          <Link href="https://www.luluwebstudio.com" target="_blank" rel="noopener noreferrer">
            <Image
              ...
              height={52}
              quality={75}
              className="opacity-40 transition-opacity duration-200 hover:opacity-70"
